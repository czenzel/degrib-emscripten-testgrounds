...
emcc --memory-init-file 0 -s ALLOW_MEMORY_GROWTH=1 -o dist/degrib.unity.js --pre-js javascript/pre-browser.js --post-js javascript/post-browser.js src/degrib.bc src/include-fs.bc
